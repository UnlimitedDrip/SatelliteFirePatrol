...
var __exports__ = (() => {
  ...
  var FilterTypes;
  (function(FilterTypes2) {
    FilterTypes2["In"] = "in";
    FilterTypes2["Between"] = "between";
    FilterTypes2["ClosedOpen"] = "closed_open";
    FilterTypes2["Time"] = "time";
    FilterTypes2["StringSearch"] = "stringSearch";
...
`;
  ...
  function getColorAccessor({
    ...
    const scale = calculateLayerScale(colorColumn || name, scaleType, range2, data);
