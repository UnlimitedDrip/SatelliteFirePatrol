...
function getHiResTimestamp() {
  ...
  if ((0, import_env2.isBrowser)() && import_env2.window.performance) {
    ...
    timestamp = import_env2.window === null || import_env2.window === void 0 ? void 0 : (_window$performance = import_env2.window.performance) === null || _window$performance === void 0 ? void 0 : (_window$performance$n = _window$performance.now) === null || _window$performance$n === void 0 ? void 0 : _window$performance$n.call(_window$performance);
  } else if ("hrtime" in import_env2.process) {
    var _process$hrtime;
    const timeParts = import_env2.process === null || import_env2.process === void 0 ? void 0 : (_process$hrtime = import_env2.process.hrtime) === null || _process$hrtime === void 0 ? void 0 : _process$hrtime.call(import_env2.process);
...
var Log = class {
  ...
  image(_ref) {
    ...
    return (0, import_env3.isBrowser)() ? logImageInBrowser({
      image,
      message,
      scale
    }) : logImageInNode({
